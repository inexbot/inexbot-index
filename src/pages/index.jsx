  ...
  return (
    <div>
      ...
      <div className="product">
        <Product BannerWidth={BannerWidth} TypeList={props.TypeList} productList={props.productList} />
      </div>
      {/* 产品介绍 */}
      ...
      <div className="partner">
        <Patner BannerWidth={BannerWidth} productList={props.productList} TypeList={props.TypeList} />
      </div>
      {/* 新闻资讯 */}
      <div className="newsInformation">
        <NewsInformation BannerWidth={BannerWidth} inpormation={props.productList} TypeList={props.TypeList} />
      </div>
    </div>
  );
}
