    ...
    <div className="children_faq">
      ...
      <div className="faq_selectAll">
        <ul className="fa1_select">
          {faqSelectlist === null? "" : faqSelectlist.map((item, index) => {
            return (
              <li
                key={index}
                onClick={() => {
        ...
        <div className="faq_table" style={ contentShow? { display:"block" } : { display:"none" }}> 
          <Table
            columns={dataColumns}
        ...
        <div className="fa1_content" style={ contentShow? { display:"none" } : { display:"block" }}>
          <img
