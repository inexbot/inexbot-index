    ...
    <div className="product_content_detail">
      <div className="detail_left">
        {props.productDetailClick === null ? (
          ...
          <dl className="detail_left_top">
            ...
            <dd>
              {' '}
              <img src={props.productDetailClick.litpic} alt="" />{' '}
            </dd>
          </dl>
        )}
        <p> 产品简介 </p>
        <div
          className="product_content_detail_html"
      ...
      <ul className="detail_right">
        {props.productData === null
          ? ''
          : props.productData[[props.productNum[0]]]
              .slice(0, props.productChildrenNum)
              .map((item, index) => {
                return (
                  <li
                    key={index}
                    className="detail_right_list"
                    onClick={() => {
